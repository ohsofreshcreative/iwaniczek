...
class Portfolio extends Block
{
    ...
    public $description = 'portfolio';
    public $slug = 'portfolio';
    public $icon = 'admin-post';
    public $keywords = ['posts', 'portfolio', 'wpisy', 'kategoria', 'portfolio', 'cpt', 'realizacje', 'projekty'];
    public $mode = 'edit';
    public $supports = [
        'align' => false,
        'mode' => true,
    ...
    public function fields()
    {
        ...
        $portfolio
            ->setLocation('block', '==', 'acf/portfolio') // ważne!
            ->addText('block-title', [
                'label' => 'Tytuł bloku',
                'required' => 0,
            ])
            ->addAccordion('accordion1', [
                'label' => 'Portfolio - Ostatnie realizacje',
                'open' => true,
                'multi_expand' => true,
            ])
            /*--- FIELDS ---*/
