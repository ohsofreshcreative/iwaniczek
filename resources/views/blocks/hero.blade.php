...
<div
    id="heroVideoModal"
    class="fixed inset-0 z-[999] hidden items-center justify-center bg-black/80 p-6">

    <div class="relative w-full max-w-5xl">

        <button
            id="heroVideoClose"
            class="absolute -top-12 right-0 text-white text-5xl leading-none">
            &times;
        </button>
...
<button
    id="heroPlayBtn"
    class="custom-play-btn absolute inset-0 flex items-center justify-center z-50"
